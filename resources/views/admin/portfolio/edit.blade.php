                        ...
                        <form method="post" action="{{ $route ."/".$data->id }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name"
                                       placeholder="Skill" name="name" value="{{$data->name}}" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                @enderror
                                <input type="text" class="form-control" id="name"
                                       placeholder="Type" name="type" value="{{$data->type}}" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                @enderror
                                <input type="text" class="form-control" id="name"
                                       placeholder="URL" name="url" value="{{$data->url}}" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <p class="invalid-feedback text-danger" role="alert"><strong>{{ $message }}</strong></p>
                                @enderror
                                <textarea name="description" class="form-control" id="description" cols="30" rows="10" style="resize: none">{{$data->description}}</textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <p class="invalid-feedback text-danger" role="alert"><strong>{{ $message }}</strong></p>
                                @enderror
                                <input type="file" id="logo" name="logo" class="dropify" data-default-file="{{asset('uploads/portfolio')."/".$data->logo}}"/>
                            </div>
