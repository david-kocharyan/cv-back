            ...
            <div class="panel panel-info">
                ...
                <div class="panel-wrapper collapse in" aria-expanded="true">
                    <div class="panel-body">
                        <form method="post" action="{{ $route ."/". $education->id }}" enctype="multipart/form-data">
                            @csrf
                            @method("PUT")
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="profession"
                                       placeholder="Profession" name="profession" value="{{$education->profession}}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="university"
                                       placeholder="University" name="university" value="{{$education->university}}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <p class="invalid-feedback text-danger" role="alert"><strong>{{ $message }}</strong></p>
                                @enderror
                                <textarea class="form-control" name="description" id="description" cols="30" rows="10" style="resize: none">{{$education->description}}</textarea>
                            </div>
